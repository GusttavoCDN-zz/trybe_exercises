...
describe('Teste a função fetchCharacter', () => {
  ...
  it('Verifica se retorna erro ao exectar a função sem parâmetro', async () => {
    const failRequest = await fetchCharacter();
    expect(failRequest).toBeInstanceOf(Error);
    expect(failRequest).toHaveProperty('message', 'You must provide an url');
  });
